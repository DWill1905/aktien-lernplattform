...
export const GLOSSAR: GlossarEntry[] = [
  ...
  { term: "GTC-Order", definition: "Good till Cancelled: Order bleibt gültig, bis sie ausgeführt oder storniert wird – Gegenstück zur Tagesorder." },
  ...
  { term: "OCO-Order", definition: "One Cancels the Other: zwei verknüpfte Orders (z. B. Stop-Loss und Take-Profit) – die Ausführung der einen storniert die andere." },
  ...
  { term: "Slippage", definition: "Differenz zwischen erwartetem und tatsächlichem Ausführungskurs, z. B. weil Market-/Stop-Orders die schlechtere Seite des Spreads zahlen." },
