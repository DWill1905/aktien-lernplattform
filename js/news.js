...
export const NEWS_EVENTS = [
    {
        ...
        stockId: "bsr",
        impactPct: -0.06,
        explanation: "Höhere Zinsen verteuern Kredite und senken den Barwert künftiger Gewinne – wachstumsstarke, noch nicht durchgehend profitable Technologiewerte reagieren besonders empfindlich.",
    },
    {
        id: "umsatzverfehlung",
...
export function pickRandomEvent(excludeId) {
...
export function resolveNews(event, decision) {
    if (decision === "hold")
        return { correct: null, impactPct: event.impactPct };
