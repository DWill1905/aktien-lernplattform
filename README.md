...
GitHub Pages. Drei Lernmodule mit Quizzes und ein risikofreier Portfolio-Simulator mit
fiktiven, lokal generierten Aktienkursen.
...
- **Grundlagen** – Was ist eine Aktie, wie funktioniert die Börse, Aktien vs. ETFs vs. Fonds,
  Ordertypen, Risiko & Diversifikation, Dividenden & Gesamtrendite
- **Fundamentalanalyse** – Bilanz und GuV lesen, KGV/KUV/KBV, Dividendenrendite &
  Ausschüttungsquote, Wettbewerbsvorteile (Burggraben)
...
- **Portfolio-Simulator** – virtuelles Startkapital von 10.000 €, 8 fiktive Aktien mit
  seeded Random-Walk-Kursen, Kaufen/Verkaufen, Positionsübersicht, Zeit-Vorspulen, Charts
